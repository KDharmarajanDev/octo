...
def get_config(config_string="full,language_conditioned"):
    ...
    config = dict(
        ...
        eval_interval=5000,
        save_interval=5000,
        save_dir="/shared/projects/mirage2/octo_base_finetune_augmented2",
        seed=42,
        wandb=dict(
            project="octo_base_finetune_augmented2", group=placeholder(str), entity=placeholder(str)
        ),
        dataset_kwargs=dict(
            oxe_kwargs=dict(
                data_mix="mirage2",
                data_dir="/shared/projects/mirage2/merged_r2r_octo_oxe",
        ...
        eval_datasets=["berkeley_autolab_ur5_aug2", "jaco_play_ur5_aug2", "roboturk_ur5_aug2", "viola_aug2"],
    )
