...
def get_config(config_string="full,multimodal"):
    ...
    FINETUNING_KWARGS = {
        "name": "R2D2",
        "data_dir": "/home/kdharmarajan/tensorflow_datasets",
        "image_obs_keys": {"primary": "exterior_image_1_left", "wrist": None},
        ...
        "standardize_fn": ModuleSpec.create(
            "octo.data.oxe.oxe_standardization_transforms:mirage_dataset_transform",
        ),
