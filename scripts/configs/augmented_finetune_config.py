...
def get_config(config_string="full,language_conditioned"):
    ...
    config = dict(
        ...
        eval_interval=5000,
        save_interval=5000,
        save_dir="/shared/projects/mirage2/octo_base_finetune_augmented",
        seed=42,
        wandb=dict(
        ...
        dataset_kwargs=dict(
            oxe_kwargs=dict(
                data_mix="mirage",
                data_dir="/shared/projects/mirage2/finished_finetune_dataset",
        ...
        eval_datasets=["berkeley_autolab_ur5_aug", "jaco_play_ur5_aug", "roboturk_ur5_aug", "viola_aug"],
    )
